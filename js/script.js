...
// // Fetch booked data from the database
// $booked = array();
// $query = "SELECT seat_id FROM booked_seats"; // Replace 'booked_seats' with your actual table name
...
// // Convert $booked array to JSON format for use in JavaScript
// $booked_json = json_encode($booked);
// ?>
